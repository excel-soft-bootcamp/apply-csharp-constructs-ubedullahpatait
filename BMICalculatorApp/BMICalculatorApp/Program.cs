            ...
            Console.ReadKey();
              ...
              break;
                ...
                case Options.FILEINPUT:
                    ...
                    PatientDataReaderLib.PatientDataReaderType _reader = new PatientDataReaderLib.PatientDataReaderType();
                    PatientDataLib.PatientDataType patient = _reader.GetPatient(@"C:\Users\ubedullah.patait\source\repos\BMICalculatorApp\data");
                    for(int i=0; i< patient.count; i++)
                    {
                        PatientDataLib.PatientDataType patientInfo = patient[i];
                        BMIValueCalculationLib.CalculateBMI value = new BMIValueCalculationLib.CalculateBMI();
                        double BmiValue = value.BmiCalculation(patientInfo.GetUserHeight(), patientInfo.GetUserWeight());
